...
import (
	...
	"github.com/caddyserver/caddy/v2/modules/caddy-l4/layer4"
	"go.uber.org/zap"
)
...
func TestSocks4Matcher_Match(t *testing.T) {
	var curlSocks4Example1 = []byte{0x04, 0x01, 0x00, 0x50, 0x5d, 0xb8, 0xd8, 0x22, 0x00}
	var curlSocks4Example2 = []byte{0x04, 0x01, 0x01, 0xbb, 0xa5, 0xe3, 0x14, 0xcf, 0x00}

	var curlSocks4aExample1 = []byte{0x04, 0x01, 0x00, 0x50, 0x00, 0x00, 0x00, 0x01, 0x00, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x6f, 0x72, 0x67, 0x00}
	var curlSocks4aExample2 = []byte{0x04, 0x01, 0x01, 0xbb, 0x00, 0x00, 0x00, 0x01, 0x00, 0x63, 0x61, 0x64, 0x64, 0x79, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x63, 0x6f, 0x6d, 0x00}
